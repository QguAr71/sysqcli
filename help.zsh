...
sysqcli() {
    ...
    echo -e "─────────────────────────────────────────────────────────────"
    echo -e "\n\e[1;34m AI — LAZARUS + GOOSE:\e[0m"
    echo -e "  \e[1;32msysq\e[0m           - Lazarus + MCP + Citadel (produkcja, provider flash)"
    echo -e "  \e[1;32meho\e[0m            - Pełna ścieżka lazarus-agent + provider v4-pro"
    echo -e "  \e[1;32mdev\e[0m            - Sandbox: osobny lazarusd + dev SuperWing"
    echo -e "  \e[1;32meho1\e[0m           - Awaryjny: cienki lazarus-session + v4-pro"
    echo -e "  \e[1;32mgs\e[0m             - Czysty goose (cienki wrapper, domyślny provider)"
    ...
    echo -e "  \e[1;32mguard-log\e[0m       - Historia zablokowanych komend"
    echo -e ""
    echo -e "\e[1;34m SECURITY GUARD — automatyczna ochrona:\e[0m"
    echo -e "  Blokuje: rm -rf /, mkfs, dd, fork bomby, chmod -R 777 /"
